...
- Read `.claude/skills/ads/references/creative-source-registry.md` and
  `.claude/skills/ads/references/copy-frameworks.md`. For every requested field,
...
`.claude/ads-control-plane/schemas/creative-worker-result.schema.json` with
