...
- Compute unit economics by hand. Don't trust platform-attributed ROAS —
  ...
  `.claude/skills/ads/references/budget-allocation.md` for the math.
...
- Read the ad copy emotionally. Does the headline make a user feel something
  *they want to feel*? See `.claude/skills/ads/references/copy-frameworks.md` for the six
...
- Brand voice mapping: `.claude/skills/ads/references/voice-to-style.md` translates emotional
