...
4. Load `.claude/skills/ads/references/thinking-framework.md`, then the relevant workflow skill and
...
- `.claude/skills/ads/references/thinking-framework.md`: full thinking discipline.
- `.claude/skills/ads/references/scoring-system.md`: scoring behavior and coverage semantics.
- `.claude/skills/ads/references/benchmarks.md`: contextual benchmarks.
- `.claude/skills/ads/references/conversion-tracking.md`: measurement foundations.
- `.claude/skills/ads/references/compliance.md` and `compliance-requirements.md`: policy and regulation.
- `.claude/skills/ads/references/mcp-integration.md`: integration and approval boundaries.
- `.claude/skills/ads/references/additional-platforms.md`: evidence gates for channels outside the
  twelve-platform product contract; load only for adjacent-channel planning.
- `.claude/skills/ads/references/automation-tier-classifier.md`: account automation maturity.
- `.claude/skills/ads/references/status-contract.md`: deterministic `/ads status` and `/ads next` evidence and priority rules.
- `.claude/skills/ads/references/prompt-patterns.md`: worked routing, worker, evidence, mutation, and
